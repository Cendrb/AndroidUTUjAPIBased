...
public class CUExamActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (itemId != -1) {
            ...
            setTitle(TextUtil.capitalize(getString(R.string.operation_edit_x, getString(R.string.item_exam)).toLowerCase()));
        } else {
            setTitle(TextUtil.capitalize(getString(R.string.operation_new_x, getString(R.string.item_exam)).toLowerCase()));
        }
